...
file = "apertium-ro-it.ro-it.dix"
listfile2 = ["Romanian-Italian-wiktionaries.txt"]
nomen = "__n"
verb = "vb"
adj = "adj"
adv = "\"adv\""
...
with codecs.open(file,"r","utf-8") as data:
    with codecs.open("Apertium-ro-it_readable.txt","w","utf-8") as new:
        for line in data:
            if ("<e" in line):
                if pos:
